...
//***************
//THIS PEICE OF CODE WAS COPIED FROM WIKEPEDIA: https://en.wikipedia.org/wiki/Selection_sort#Implementation
//THIS IMPLEMENTATION OF SELECTION SORT WAS TAKEN FROM WIKEPEDIA: https://en.wikipedia.org/wiki/Selection_sort#Implementation
//***************
